...
function buildWelcomeEmail({ firstName, lastName, email, siteUrl }) {
  ...
  const bodyHtml = `
    <div style="text-align:center;margin-bottom:8px;">
      <span style="display:inline-block;background:#DBEAFE;color:${PRIMARY};font-size:12px;font-weight:700;padding:6px 14px;border-radius:20px;">স্বাগতম / Welcome</span>
    </div>
  ...
  return {
    subject: `🎉 ${SITE_NAME}-এ স্বাগতম, ${name}!`,
    html: baseLayout({
      title: `Welcome to ${SITE_NAME}`,
      preheader: `আপনার ${SITE_NAME} অ্যাকাউন্ট তৈরি হয়েছে।`,
      bodyHtml,
      siteUrl: home,
    }),
